...
def mostrar_texto(img, contador_parpadeo, contador_microsueño):
    color = (255, 0, 255)  # Color inicial
    cvzone.putTextRect(img, f'Contador Parpadeo: {contador_parpadeo}', (70, 100), colorR=color)
    cvzone.putTextRect(img, f'Contador Microsueño: {contador_microsueño}', (70, 160))
...
def main():
    ...
    while True:
        ...
        if faces:
            ...
            if ratio_promedio < UMBRAL_MICROSUEÑO and microsueño_inicio == 0:
                microsueño_inicio = time.time()
            elif ratio_promedio >= UMBRAL_MICROSUEÑO and microsueño_inicio != 0:
                duracion_microsueño = time.time() - microsueño_inicio
                if duracion_microsueño >= DURACION_MICROSUEÑO:
            ...
            if ratio_promedio < UMBRAL_MICROSUEÑO:
                ...
                if tiempo_actual - ultimo_tiempo_parpadeo > INTERVALO_PARPADEO:
                    contador_parpadeo += 1
                    color = (0, 200, 0)
                    ultimo_tiempo_parpadeo = tiempo_actual

            mostrar_texto(img, contador_parpadeo, contador_microsueño)
            ...
            imgPlot = plotY.update(ratio_promedio, color)
